...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function showDetail(oid,type,explain,time){
				//alert(oid);
				//发送ajax
				...
				if(type!="汽车销售"){
					var s="<table border='1' width='99%'>";
					 s+="<tr><th>服务说明</th><th>预约时间</th></tr>";
					s+="<tr><td style='height:100px;' text-align='center'>"+explain+"</td><td height='100px' text-align='center'>"+time+"</td></tr>"; 
					s+="</table>";
					layer.open({
									...
									<c:forEach items="${list }" var="o" varStatus="vs">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												...
												<input type="button" value="订单详情"  onclick="showDetail('${o.oid}','${o.type }','${o.explain }','${o.ordertime }')"/>
											</td>
